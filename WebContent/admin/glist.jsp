...
<style type="text/css">
.u{
width:100%;border-top:1px solid #1C86EE;border-right:1px solid #1C86EE;
...
ul li{
 float: left;width: 50px;line-height: 40px;text-align: center;
}
</style>
</head>
<body>
...
<%-- <textarea id="editor" style="resize:none;width:200px; height:50px;font-size: 12px;">${g.goodDescript }</textarea></td> --%> 
<td style="font-size: 14px">${g.goodNum }</td>
<td style="font-size: 14px">${g.goodType }</td>
<td style="font-size: 14px"><a href="javascript:getGoodId(${g.goodId});">修改</a>
