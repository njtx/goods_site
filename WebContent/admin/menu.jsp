							...
							<TBODY>
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_1');"><SPAN
										class=span id=table_1Span>＋</SPAN> 会员管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR> 
													<TD class=menuSmall>
													<A class=style2 
													href="${pageContext.request.contextPath}/QueryUserServlet"
														target=main>－ 查看会员列表</A></TD>
												</TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
										class=span id=table_2Span>＋</SPAN> 商品管理</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TR>
													<TD class=menuSmall><A class=style2 
														href="${pageContext.request.contextPath}/queryGoodsServlet"
														target=main>－ 查看商品列表</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2
													 href="${pageContext.request.contextPath}/admin/add.jsp"
														target=main>－ 新增商品</A></TD>
												</TR>
									...
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 
                                                    href="${pageContext.request.contextPath}/queryOrderServlet"
